...
class About extends Component {
  ...
  render() {
    ...
    return (
      ...
      The Vachan Project is the technology umbrella under which access to free digital scripture engagement resources is being made available to all. As part of this project the Vachan Online ( <Text style={this.styles.linkText} onPress={() =>{Linking.openURL('https://VachanOnline.com')}}>VachanOnline.com</Text> ) website and the Vachan Go companion mobile app have been developed for public use. The Vachan Project is an initiative of the  Friends of Agape (FOA), USA. The content herein is not for reuse or redistribution in any other format or platform without explicit permission as multiple licensing strategies are involved. {'\n'}
      ...
      Permission to use Vachan APIs can be be provided for similar digital content delivery for products with like minded vision. Please contact us at <Text style={this.styles.linkText} onPress={() =>{Linking.openURL('thevachanproject@gmail.com')}}>thevachanproject@gmail.com</Text>. Also visit our company website <Text style={this.styles.linkText} onPress={() =>{Linking.openURL('www.bridgeconn.com')}}>www.bridgeconn.com</Text> {'\n'}
    ...
    <Text style={this.styles.bulletIcon}>{'\u2022' + " "}</Text>Bibles: Updated versions of IRV Bibles in all available Indian Gateway languages.{'\n'}
    <Text style={this.styles.bulletIcon}>{'\u2022' + " "}</Text>Commentary: IRV Notes (Hindi) + Mathew Henry Concise Bible Commentary (English) + Bridgeway Bible Commentary (English) + ESV Global Study Bible Notes (English).{'\n'}
    <Text style={this.styles.bulletIcon}>{'\u2022' + " "}</Text>Dictionary: IRV Dictionary (Hindi){'\n'}
    <Text style={this.styles.bulletIcon}>{'\u2022' + " "}</Text>Infographics: VisualUnit (Hindi)* {'\n'}
    <Text style={this.styles.bulletIcon}>{'\u2022' + " "}</Text>Audio: IRV NT Bible (Hindi){'\n'}
    ...
    * Not available on the Vachan Go companion mobile app{'\n'}
    ...
    <Text style={this.styles.bulletIcon}>{'\u2022' + " "}</Text>Basic Bible search.{'\n'}
    <Text style={this.styles.bulletIcon}>{'\u2022' + " "}</Text>Dynamic Data{'\n'}
    <Text style={this.styles.bulletIcon}>{'\u2022' + " "}</Text>Personalisation{'\n'}
    <Text style={this.styles.bulletIcon}>{'\u2022' + " "}</Text>Seamless transfer of User Data between Vachan Online and Vachan Go.{'\n'}
