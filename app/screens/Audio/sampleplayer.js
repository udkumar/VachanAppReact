...
sound = new Sound('tt.mp3',Sound.MAIN_BUNDLE,(error) =>{
  if (error) {
      console.log('failed to load the sound', error);
      return;
    }
})
const img_speaker = require('../../assets/backmusic.jpg');
const img_pause = require('../../assets/backmusic.jpg');
const img_play = require('../../assets/backmusic.jpg');
const img_playjumpleft = require('../../assets/backmusic.jpg');
const img_playjumpright = require('../../assets/backmusic.jpg');
                ...
                <View style={{marginVertical:15, marginHorizontal:15, flexDirection:'row'}}>
                    ...
                    <Slider
                        ...
                        value={this.state.playSeconds}
                         maximumValue={this.state.duration} maximumTrackTintColor='gray' minimumTrackTintColor='white' thumbTintColor='white' 
