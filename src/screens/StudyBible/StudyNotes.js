            ...
            <View>
                ...
                >
                  <View>
                            ...
                            //       {/* {
                            //         item.type == 'fq' ?  
                            //         <Text style={{margin:8,fontWeight:item.type=='fq' ? 'bold': 'normal'}}>
                            //           Note: {item.verseNumber} {item.text} 
                            //         </Text>
                            //           : item.type == 'f' ? <Text style={{margin:8}} >{item.text}</Text> 
                            //           :null
                            //       } */}
                            //        {/* {
                            //         item.type == 'fq' ?  
                            ...
                            //           Note: {item.verseNumber}{item.text} 
                            //         </Text>
                            //           : item.type == 'ft' ? <Text style={{margin:8}}>{item.text}</Text>  */}
                            //           {/* :null */}
                            //       {/* }  */}
                            }
